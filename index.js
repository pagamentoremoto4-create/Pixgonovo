...
function page(title, body) {
  ...
  <style>
  :root{--bg:#020603;--panel:#071207;--panel2:#0a160b;--card:#081308;--line:rgba(0,255,88,.24);--line2:rgba(255,255,255,.08);--text:#f1fff4;--muted:#94a69a;--green:#33ff3d;--green2:#00c853;--red:#ff3030;--blue:#1188ff;--yellow:#ffd21f;--purple:#925cff;--shadow:0 18px 48px rgba(0,0,0,.55);--glow:0 0 22px rgba(51,255,61,.26)}
  *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;font-family:Inter,Arial,sans-serif;color:var(--text);min-height:100vh;background:#020603;background-image:linear-gradient(rgba(0,255,80,.035) 1px,transparent 1px),linear-gradient(90deg,rgba(0,255,80,.035) 1px,transparent 1px),radial-gradient(circle at 30% 0%,rgba(0,255,72,.18),transparent 30%),radial-gradient(circle at 90% 15%,rgba(0,200,83,.14),transparent 30%),linear-gradient(135deg,#010301,#050d06 55%,#000);background-size:34px 34px,34px 34px,auto,auto,auto}body:before{content:'';position:fixed;inset:0;pointer-events:none;background:linear-gradient(180deg,rgba(0,0,0,.12),rgba(0,0,0,.32)),repeating-linear-gradient(0deg,rgba(255,255,255,.025),rgba(255,255,255,.025) 1px,transparent 1px,transparent 4px);mix-blend-mode:screen;opacity:.38;z-index:0}a{color:#afffb9;text-decoration:none}.layout{position:relative;z-index:1;display:grid;grid-template-columns:290px minmax(0,1fr);min-height:100vh}.side{position:sticky;top:0;height:100vh;padding:22px;background:linear-gradient(180deg,rgba(0,10,4,.98),rgba(3,15,7,.95));border-right:1px solid var(--line);box-shadow:18px 0 60px rgba(0,0,0,.55);overflow:auto}.brand{display:flex;align-items:center;gap:12px;margin-bottom:20px;font-weight:950;letter-spacing:.3px}.brand-lock{width:58px;height:58px;border-radius:18px;display:grid;place-items:center;background:rgba(0,255,88,.12);border:1px solid rgba(0,255,88,.55);box-shadow:0 0 24px rgba(0,255,88,.25);font-size:32px}.brand-text strong{display:block;font-size:24px;line-height:1;color:#fff;text-shadow:0 0 15px rgba(51,255,61,.45)}.brand-text span{display:block;color:var(--green);font-size:24px;line-height:1}.brand-sub{font-size:11px;color:#9aa99e;letter-spacing:2px;margin-top:6px}.side .nav-title{font-size:11px;text-transform:uppercase;letter-spacing:1.6px;color:#6f8374;margin:18px 12px 8px}.side a{display:flex;align-items:center;gap:11px;padding:13px 14px;border-radius:10px;margin:6px 0;color:#d8eadb;font-weight:800;border:1px solid transparent;text-transform:uppercase;font-size:13px}.side a:hover,.side a.active{background:linear-gradient(90deg,rgba(30,255,64,.25),rgba(30,255,64,.04));border-color:rgba(51,255,61,.35);box-shadow:inset 3px 0 0 var(--green),0 0 22px rgba(51,255,61,.12);color:#fff}.side-profile{margin-top:14px;border:1px solid var(--line);border-radius:16px;background:linear-gradient(180deg,rgba(0,255,88,.06),rgba(0,0,0,.25));padding:14px;overflow:hidden}.side-profile-img{height:120px;border-radius:14px;background:linear-gradient(90deg,rgba(0,0,0,.8),rgba(0,0,0,.15)),url('/assets/img/hacker-dashboard.png') center/cover no-repeat;border:1px solid rgba(0,255,88,.25);margin-bottom:10px}.side-profile b{color:var(--green)}.main{padding:24px;max-width:1640px;width:100%;margin:0 auto}.topline{display:flex;align-items:center;justify-content:space-between;gap:14px;margin-bottom:18px}.searchbox{display:flex;align-items:center;gap:10px;width:min(460px,100%);border:1px solid rgba(0,255,88,.35);background:rgba(0,0,0,.28);border-radius:13px;padding:12px 16px;color:#78937d}.status-top{display:flex;align-items:center;gap:20px;color:#d9ffe0}.status-dot{width:10px;height:10px;border-radius:50%;background:var(--green);box-shadow:0 0 15px var(--green);display:inline-block;margin-right:6px}.clock{font-weight:950;font-size:20px;color:#fff}.hero{min-height:250px;display:grid;grid-template-columns:minmax(0,1fr) 380px;gap:20px;align-items:center;position:relative;overflow:hidden;border:1px solid var(--line);border-radius:18px;padding:28px 32px;margin-bottom:14px;background:linear-gradient(90deg,rgba(0,0,0,.78) 0%,rgba(0,0,0,.40) 46%,rgba(0,0,0,.72) 100%),url('/assets/img/hacker-dashboard.png') center/cover no-repeat;box-shadow:var(--shadow),var(--glow)}.hero:before{content:'';position:absolute;inset:0;background:radial-gradient(circle at 55% 35%,rgba(0,255,88,.14),transparent 32%);pointer-events:none}.hero-content,.system-card{position:relative;z-index:1}.hero h1{margin:0;font-size:34px;line-height:1.06;text-transform:uppercase}.hero h1 span{display:block;color:var(--green);text-shadow:0 0 18px rgba(51,255,61,.52)}.hero p{margin:14px 0 0;color:#eaffee;font-size:18px;line-height:1.45;text-transform:uppercase;letter-spacing:.3px}.system-card{justify-self:end;width:100%;max-width:380px;background:rgba(0,0,0,.58);border:1px solid rgba(0,255,88,.25);border-radius:16px;padding:18px;backdrop-filter:blur(7px)}.system-card h3{margin:0 0 16px;text-transform:uppercase}.sys-row{display:flex;justify-content:space-between;border-top:1px solid rgba(255,255,255,.08);padding:11px 0;color:#d8e6db}.online{color:var(--green);font-weight:950}.topbar{display:flex;justify-content:space-between;gap:14px;align-items:center;margin:20px 0 12px}.card{background:linear-gradient(180deg,rgba(4,16,7,.88),rgba(2,8,4,.94));border:1px solid var(--line);border-radius:14px;padding:18px;margin:14px 0;box-shadow:var(--shadow)}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(210px,1fr));gap:14px}.metric{position:relative;overflow:hidden;min-height:132px}.metric:before{content:'';position:absolute;left:16px;top:22px;width:58px;height:58px;border-radius:50%;background:rgba(51,255,61,.12);box-shadow:0 0 28px rgba(51,255,61,.18)}.metric:after{content:'';position:absolute;left:0;right:0;bottom:0;height:32px;background:linear-gradient(90deg,transparent,rgba(51,255,61,.2));clip-path:polygon(0 80%,15% 65%,28% 75%,45% 35%,60% 55%,80% 25%,100% 38%,100% 100%,0 100%)}.metric h2{position:relative;margin:0 0 8px 78px;font-size:13px;color:#e7f7ea;text-transform:uppercase;letter-spacing:.7px}.metric h1{position:relative;margin:0 0 0 78px;font-size:32px}.metric small{position:relative;margin-left:78px;color:var(--green);font-weight:850}.metric.yellow:before{background:rgba(255,210,31,.16);box-shadow:0 0 28px rgba(255,210,31,.22)}.metric.yellow:after{background:linear-gradient(90deg,transparent,rgba(255,210,31,.28))}.metric.blue:before{background:rgba(17,136,255,.16);box-shadow:0 0 28px rgba(17,136,255,.22)}.metric.blue:after{background:linear-gradient(90deg,transparent,rgba(17,136,255,.28))}.metric.red:before{background:rgba(255,48,48,.16);box-shadow:0 0 28px rgba(255,48,48,.22)}.metric.red:after{background:linear-gradient(90deg,transparent,rgba(255,48,48,.28))}.two-col{display:grid;grid-template-columns:1.1fr 1fr;gap:14px}.chart{height:260px;display:flex;align-items:end;gap:12px;border-left:1px solid rgba(255,255,255,.12);border-bottom:1px solid rgba(255,255,255,.12);padding:10px 12px 26px;margin-top:16px;background:linear-gradient(rgba(0,255,88,.05) 1px,transparent 1px);background-size:100% 42px}.bar{flex:1;min-width:24px;background:linear-gradient(180deg,var(--green),rgba(0,200,83,.18));border:1px solid rgba(51,255,61,.45);border-radius:9px 9px 0 0;box-shadow:0 0 18px rgba(51,255,61,.22);position:relative}.bar span{position:absolute;left:50%;bottom:-24px;transform:translateX(-50%);font-size:11px;color:#9eb0a2}.btn{display:inline-flex;align-items:center;justify-content:center;gap:6px;background:linear-gradient(135deg,#16a34a,#0b7d2b);color:white!important;padding:9px 13px;border-radius:10px;border:1px solid rgba(51,255,61,.35);cursor:pointer;margin:2px;font-weight:900;box-shadow:0 0 18px rgba(51,255,61,.16);text-transform:uppercase;font-size:12px}.btn.red{background:linear-gradient(135deg,#ef4444,#991b1b);border-color:rgba(255,48,48,.4)}.btn.green{background:linear-gradient(135deg,#22c55e,#15803d);color:white!important}.btn.gray{background:linear-gradient(135deg,#64748b,#334155)}.btn.orange{background:linear-gradient(135deg,#f97316,#c2410c)}.btn.purple{background:linear-gradient(135deg,#a855f7,#6d28d9);color:white!important}input,select,textarea{padding:12px;border-radius:10px;border:1px solid rgba(0,255,88,.25);background:#020803;color:var(--text);width:100%;min-width:130px;outline:none}input:focus,select:focus,textarea:focus{border-color:var(--green);box-shadow:0 0 0 3px rgba(51,255,61,.11)}label{font-size:12px;color:#91a796;font-weight:900;text-transform:uppercase;letter-spacing:.8px}table{width:100%;border-collapse:separate;border-spacing:0;background:rgba(1,8,3,.84);border-radius:14px;overflow:hidden;border:1px solid rgba(0,255,88,.20)}td,th{border-bottom:1px solid rgba(255,255,255,.07);padding:12px;text-align:left;vertical-align:middle}th{color:#d9ffe0;background:rgba(0,20,7,.95);font-size:12px;text-transform:uppercase;letter-spacing:.7px}tr:last-child td{border-bottom:0}tr:hover td{background:rgba(51,255,61,.06)}.muted{color:var(--muted)}.pill{padding:5px 10px;border-radius:999px;background:rgba(51,255,61,.11);border:1px solid rgba(51,255,61,.34);display:inline-block;font-weight:950;color:#dfffdf;font-size:12px}.forms-inline{display:inline}.actions{white-space:nowrap}.search{display:grid;grid-template-columns:1fr 120px;gap:8px;max-width:560px}.service-card{display:grid;grid-template-columns:1fr auto;gap:14px;align-items:center;background:linear-gradient(135deg,rgba(3,14,6,.96),rgba(0,0,0,.78));border:1px solid rgba(51,255,61,.24);border-radius:16px;padding:16px;margin:12px 0;box-shadow:0 0 20px rgba(51,255,61,.08)}.service-title{font-size:18px;font-weight:950}.service-meta{display:flex;flex-wrap:wrap;gap:8px;margin-top:8px}.tag{display:inline-flex;align-items:center;gap:6px;border-radius:999px;padding:6px 10px;background:rgba(51,255,61,.09);border:1px solid rgba(51,255,61,.22);color:#dbe7f5;font-weight:900;font-size:12px}.form-grid{display:grid;grid-template-columns:2fr 1fr 1fr 1.3fr;gap:12px}.mini-help{background:rgba(51,255,61,.07);border:1px dashed rgba(51,255,61,.28);padding:12px;border-radius:14px;color:#d8ffdd}.empty{padding:28px;text-align:center;color:var(--muted)}@media(max-width:1100px){.two-col{grid-template-columns:1fr}.hero{grid-template-columns:1fr}.system-card{justify-self:start}}@media(max-width:900px){.layout{grid-template-columns:1fr}.side{height:auto;position:relative}.brand{margin-bottom:10px}.side .nav-title{display:none}.side a{display:inline-flex;padding:10px 12px}.side-profile{display:none}.main{padding:12px}.topline{display:block}.searchbox{margin-bottom:12px}.search,.form-grid{grid-template-columns:1fr}table{font-size:12px;display:block;overflow-x:auto}.actions{white-space:normal}.service-card{grid-template-columns:1fr}.hero{min-height:240px;padding:20px}.hero h1{font-size:28px}.hero p{font-size:15px}.metric h2,.metric h1,.metric small{margin-left:70px}}
  </style></head><body><div class="layout"><aside class="side"><div class="brand"><div class="brand-lock">🔐</div><div class="brand-text"><strong>CENTRAL</strong><span>UNLOCKER</span><div class="brand-sub">UNLOCK EVERYTHING</div></div></div><div class="nav-title">Painel</div><a href="/admin">📊 Dashboard</a><a href="/admin/pedidos">📋 Pedidos</a><a href="/admin/revendas">👥 Revendas</a><a href="/admin/servicos">🛠 Serviços</a><a href="/admin/financeiro">💰 Financeiro</a><a href="/admin/relatorios">📈 Relatórios</a><a href="/admin/backup">💾 Backup</a><div class="nav-title">Sistema</div><a href="/admin/config">⚙️ Configurações</a><a href="/admin/logout">🚪 Sair</a><div class="side-profile"><div class="side-profile-img"></div><div><b>Admin MASTER</b><br><span class="muted">Sessão ativa</span><br><span class="online">● Painel 100% seguro</span></div></div></aside><main class="main"><div class="topline"><div class="searchbox">🔎 Buscar no sistema...</div><div><span class="status-dot"></span>BOT WHATSAPP <span class="online">${conectado ? 'CONECTADO' : 'DESCONECTADO'}</span> &nbsp; <span class="clock" id="clock">--:--:--</span></div></div>${body}</main></div><script>function tick(){const d=new Date();const e=document.getElementById('clock');if(e)e.textContent=d.toLocaleTimeString('pt-BR');}tick();setInterval(tick,1000);</script></body></html>`;
}
...
app.get('/admin', async (req, res) => {
  ...
  const rows7 = await all(`SELECT date(criado_em) dia, COUNT(*) qtd FROM pedidos WHERE date(criado_em) >= date('now','-6 day') GROUP BY date(criado_em)`);
  const mapa7 = Object.fromEntries(rows7.map(r => [r.dia, Number(r.qtd || 0)]));
  const dias = [];
  for (let i = 6; i >= 0; i--) {
    const d = new Date();
    d.setDate(d.getDate() - i);
    const iso = d.toISOString().slice(0, 10);
    dias.push({ label: iso.slice(5).split('-').reverse().join('/'), qtd: mapa7[iso] || 0 });
  }
  const max7 = Math.max(1, ...dias.map(d => d.qtd));
  const chart = `<div class="chart">${dias.map(d => `<div class="bar" title="${d.qtd} pedidos" style="height:${18 + (d.qtd / max7) * 82}%"><span>${d.label}</span></div>`).join('')}</div>`;
  let table = '<table><tr><th>ID</th><th>Serviço</th><th>Entrada</th><th>Revenda</th><th>Status</th></tr>';
  for (const o of ult) table += `<tr><td>#${o.id}</td><td>${safeHtml(o.servico_nome)}</td><td>${safeHtml(o.entrada_valor || o.imei || '-')}</td><td>${safeHtml(o.revenda_nome || o.cliente_nome || '-')}</td><td><span class="pill">${safeHtml(o.status)}</span></td></tr>`;
  table += '</table>';
  res.send(page('Dashboard', `<div class="hero"><div class="hero-content"><h1>PAINEL <span>CENTRALUNLOCKER</span></h1><p>Controle total na palma da sua mão.</p></div><div class="system-card"><h3>Status do Sistema</h3><div class="sys-row"><span>API Principal</span><b class="online">CONECTADO</b></div><div class="sys-row"><span>Bot WhatsApp</span><b class="online">${conectado ? 'CONECTADO' : 'OFFLINE'}</b></div><div class="sys-row"><span>Processador</span><b class="online">ONLINE</b></div><div class="sys-row"><span>Banco de Dados</span><b class="online">ONLINE</b></div></div></div><div class="grid">
  <div class="card metric yellow"><h2>📋 Pendentes</h2><h1>${p.qtd}</h1><small>+ pedidos novos</small></div><div class="card metric blue"><h2>⚙️ Em Processo</h2><h1>${ep.qtd}</h1><small>em andamento</small></div><div class="card metric"><h2>✅ Finalizados</h2><h1>${f.qtd}</h1><small>serviços entregues</small></div><div class="card metric red"><h2>❌ Cancelados</h2><h1>${c.qtd}</h1><small>pedidos cancelados</small></div><div class="card metric"><h2>💵 Faturamento Hoje</h2><h1>${brl(hoje.total)}</h1><small>recebido hoje</small></div>
  </div><div class="two-col"><div class="card"><div class="topbar"><h2>Pedidos - últimos 7 dias</h2><span class="pill">7 dias</span></div>${chart}</div><div class="card"><div class="topbar"><h2>Últimos pedidos</h2><a class="btn" href="/admin/pedidos">Ver todos</a></div>${table}</div></div><div class="grid"><div class="card metric red"><h2>💳 Saldo geral</h2><h1>${brl(saldo.total)}</h1><small>Balanço revendas</small></div><div class="card metric"><h2>👥 Revendas ativas</h2><h1>${rev.qtd}</h1><small>clientes ativos</small></div><div class="card metric blue"><h2>🧊 Serviços ativos</h2><h1>${(await get('SELECT COUNT(*) qtd FROM servicos_catalogo WHERE ativo=1')).qtd}</h1><small>catálogo</small></div></div>`));
});
