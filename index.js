...
app.get('/admin', async (req, res) => {
  ...
  table += '</table>';
  res.send(page('Dashboard', `<div class="hero"><h1>📊 Painel CentralUnlocker</h1><p>Controle profissional de pedidos, revendas, saldo, IMEI, Lock Code e serviços manuais.</p></div><div class="topbar"><h1>Resumo geral</h1><span class="muted">${dateBR(new Date())}</span></div><div class="grid">
